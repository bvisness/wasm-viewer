...
import { parse_export_section, parse_function_section, parse_global_section, parse_import_section, parse_memory_section, parse_table_section, parse_type_section } from "../wasm-tools/pkg/wasm_viewer";
